...
## Maven Coordinates
We publish all our releases to maven central repository: [spark-msgpack-datasource-4.1_2.13](https://central.sonatype.com/artifact/io.github.cybercentrecanada/spark-msgpack-datasource-4.1_2.13)
